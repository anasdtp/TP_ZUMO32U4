/* provide functions for configuring the Zumo 32U4's gyro, 
...
Our convention is that a value of 0x08000000 represents a 45
...
int32_t turnSensorUpdate()
{
  ...
  // The units of d are gyro digits  microseconds.  We need
  // to convert those to the units of turnAngle, where 2^27 units
